#ifndef _ROS_wheelchair_msgs_wheelVels_h
#define _ROS_wheelchair_msgs_wheelVels_h
...
namespace wheelchair_msgs
{

  class wheelVels : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "wheelchair_msgs/wheelVels"; };
    const char * getMD5(){ return "32913dc47e757fdbf18d25c27a580fbf"; };
